...
struct tag_sTarget3_VMT {
    int            (*send__T)( const struct tag_sTarget3_VDES *edp, const int8_t* buf, int8_t len );
    int            (*sendMessage__T)( const struct tag_sTarget3_VDES *edp, const char_t* buf, int8_t len );
    int            (*sendStruct__T)( const struct tag_sTarget3_VDES *edp, const struct target_struct* data );
    int            (*receiveMessage__T)( const struct tag_sTarget3_VDES *edp, char_t* buf, int8_t len );
};
