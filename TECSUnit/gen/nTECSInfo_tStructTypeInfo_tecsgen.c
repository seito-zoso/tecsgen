...
extern struct tag_nTECSInfo_sVarDeclInfo_VDES rTEMP_rTECSInfo_struct____pthread_t___dummyVarDeclInfo_eVarDeclInfo_des;

extern struct tag_nTECSInfo_sVarDeclInfo_VDES rTEMP_rTECSInfo_struct____pthread_cond_t___dummyVarDeclInfo_eVarDeclInfo_des;

extern struct tag_nTECSInfo_sVarDeclInfo_VDES rTEMP_rTECSInfo_struct____pthread_mutex_t___dummyVarDeclInfo_eVarDeclInfo_des;
...
struct tag_nTECSInfo_sVarDeclInfo_VDES * const rTEMP_rTECSInfo_struct____pthread_tTypeInfo_cVarDeclInfo[] = {
    &rTEMP_rTECSInfo_struct____pthread_t___dummyVarDeclInfo_eVarDeclInfo_des,
};

struct tag_nTECSInfo_sVarDeclInfo_VDES * const rTEMP_rTECSInfo_struct____pthread_cond_tTypeInfo_cVarDeclInfo[] = {
    &rTEMP_rTECSInfo_struct____pthread_cond_t___dummyVarDeclInfo_eVarDeclInfo_des,
};

struct tag_nTECSInfo_sVarDeclInfo_VDES * const rTEMP_rTECSInfo_struct____pthread_mutex_tTypeInfo_cVarDeclInfo[] = {
    &rTEMP_rTECSInfo_struct____pthread_mutex_t___dummyVarDeclInfo_eVarDeclInfo_des,
};
...
nTECSInfo_tStructTypeInfo_INIB nTECSInfo_tStructTypeInfo_INIB_tab[] = {
    ...
    /* cell: nTECSInfo_tStructTypeInfo_CB_tab[5]:  struct____pthread_tTypeInfo id=6 */
    {
        /* call port (INIB) #_CP_# */ 
        rTEMP_rTECSInfo_struct____pthread_tTypeInfo_cVarDeclInfo, /* #_CCP3B_# */
    ...
    /* cell: nTECSInfo_tStructTypeInfo_CB_tab[6]:  struct____pthread_cond_tTypeInfo id=7 */
    {
        /* call port (INIB) #_CP_# */ 
        rTEMP_rTECSInfo_struct____pthread_cond_tTypeInfo_cVarDeclInfo, /* #_CCP3B_# */
        1,                                       /* length of cVarDeclInfo (n_cVarDeclInfo) #_CCP4_# */
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
    ...
    /* cell: nTECSInfo_tStructTypeInfo_CB_tab[7]:  struct____pthread_mutex_tTypeInfo id=8 */
    {
        /* call port (INIB) #_CP_# */ 
        rTEMP_rTECSInfo_struct____pthread_mutex_tTypeInfo_cVarDeclInfo, /* #_CCP3B_# */
        1,                                       /* length of cVarDeclInfo (n_cVarDeclInfo) #_CCP4_# */
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
...
const struct tag_nTECSInfo_tStructTypeInfo_eTypeInfo_DES rTEMP_rTECSInfo_struct__t_rsemTypeInfo_eTypeInfo_des = {
    ...
    &nTECSInfo_tStructTypeInfo_INIB_tab[0],   /* INIB 4 */
};
...
const struct tag_nTECSInfo_tStructTypeInfo_eTypeInfo_DES rTEMP_rTECSInfo_struct__t_rflgTypeInfo_eTypeInfo_des = {
    &nTECSInfo_tStructTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tStructTypeInfo_INIB_tab[1],   /* INIB 4 */
};
...
const struct tag_nTECSInfo_tStructTypeInfo_eTypeInfo_DES rTEMP_rTECSInfo_struct__t_rdtqTypeInfo_eTypeInfo_des = {
    &nTECSInfo_tStructTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tStructTypeInfo_INIB_tab[2],   /* INIB 4 */
};
...
const struct tag_nTECSInfo_tStructTypeInfo_eTypeInfo_DES rTEMP_rTECSInfo_struct__target_structTypeInfo_eTypeInfo_des = {
    &nTECSInfo_tStructTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tStructTypeInfo_INIB_tab[3],   /* INIB 4 */
};
...
const struct tag_nTECSInfo_tStructTypeInfo_eTypeInfo_DES rTEMP_rTECSInfo_struct__tecsunit_objTypeInfo_eTypeInfo_des = {
    &nTECSInfo_tStructTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tStructTypeInfo_INIB_tab[4],   /* INIB 4 */
};
extern const struct tag_nTECSInfo_tStructTypeInfo_eTypeInfo_DES rTEMP_rTECSInfo_struct____pthread_tTypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tStructTypeInfo_eTypeInfo_DES rTEMP_rTECSInfo_struct____pthread_tTypeInfo_eTypeInfo_des = {
    &nTECSInfo_tStructTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tStructTypeInfo_INIB_tab[5],   /* INIB 4 */
};
extern const struct tag_nTECSInfo_tStructTypeInfo_eTypeInfo_DES rTEMP_rTECSInfo_struct____pthread_cond_tTypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tStructTypeInfo_eTypeInfo_DES rTEMP_rTECSInfo_struct____pthread_cond_tTypeInfo_eTypeInfo_des = {
    &nTECSInfo_tStructTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tStructTypeInfo_INIB_tab[6],   /* INIB 4 */
};
extern const struct tag_nTECSInfo_tStructTypeInfo_eTypeInfo_DES rTEMP_rTECSInfo_struct____pthread_mutex_tTypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tStructTypeInfo_eTypeInfo_DES rTEMP_rTECSInfo_struct____pthread_mutex_tTypeInfo_eTypeInfo_des = {
    &nTECSInfo_tStructTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tStructTypeInfo_INIB_tab[7],   /* INIB 4 */
};
