...
ER           nTECSInfo_tTECSInfoSub_eTECSInfo_findRawEntryDescriptor_unsafe( const char_t* namespace_path, void** rawDesc);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
#define nTECSInfo_tTECSInfoSub_cRawEntryDescriptorInfoTemp_getRawDescriptor( ith, rawDesc ) \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRawEntryDescriptorInfoTemp->VMT->getRawDescriptor__T( \
	  nTECSInfo_tTECSInfoSub_SINGLE_CELL_CB.cRawEntryDescriptorInfoTemp, (ith), (rawDesc) )
...
ER             nTECSInfo_tTECSInfoSub_eTECSInfo_findRawEntryDescriptor_unsafe_skel( const struct tag_nTECSInfo_sTECSInfo_VDES *epd, const char_t* namespace_path, void** rawDesc);
...
#define cRawEntryDescriptorInfoTemp_getRawDescriptor( ith, rawDesc ) \
          nTECSInfo_tTECSInfoSub_cRawEntryDescriptorInfoTemp_getRawDescriptor( ith, rawDesc )
