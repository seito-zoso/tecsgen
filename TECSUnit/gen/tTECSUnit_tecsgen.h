...
#define tTECSUnit_cTECSInfo_findRawEntryDescriptor_unsafe( p_that, namespace_path, rawDesc ) \
...
#define tTECSUnit_cREDInfo_getNRawEntryDescriptorInfo( p_that ) \
	  (p_that)->cREDInfo->VMT->getNRawEntryDescriptorInfo__T( \
	   (p_that)->cREDInfo )
#define tTECSUnit_cREDInfo_getRawDescriptor( p_that, ith, rawDesc ) \
	  (p_that)->cREDInfo->VMT->getRawDescriptor__T( \
	   (p_that)->cREDInfo, (ith), (rawDesc) )
...
#define cTECSInfo_findRawEntryDescriptor_unsafe( namespace_path, rawDesc ) \
          ((void)p_cellcb, tTECSUnit_cTECSInfo_findRawEntryDescriptor_unsafe( p_cellcb, namespace_path, rawDesc ))
...
#define cREDInfo_getRawDescriptor( ith, rawDesc ) \
          tTECSUnit_cREDInfo_getRawDescriptor( p_cellcb, ith, rawDesc )
