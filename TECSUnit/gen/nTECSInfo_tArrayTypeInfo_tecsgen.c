...
nTECSInfo_tArrayTypeInfo_INIB nTECSInfo_tArrayTypeInfo_INIB_tab[] = {
    /* cell: nTECSInfo_tArrayTypeInfo_CB_tab[0]:  char_Array16_TypeInfo id=1 */
    {
        /* call port (INIB) #_CP_# */ 
    ...
    /* cell: nTECSInfo_tArrayTypeInfo_CB_tab[3]:  int32_t_Array64__Array16_TypeInfo id=4 */
    {
        /* call port (INIB) #_CP_# */ 
    ...
    /* cell: nTECSInfo_tArrayTypeInfo_CB_tab[4]:  int32_t_Array64_TypeInfo id=5 */
    {
        /* call port (INIB) #_CP_# */ 
    ...
    /* cell: nTECSInfo_tArrayTypeInfo_CB_tab[5]:  double64_t_Array32__Array16_TypeInfo id=6 */
    {
        /* call port (INIB) #_CP_# */ 
    ...
    /* cell: nTECSInfo_tArrayTypeInfo_CB_tab[6]:  double64_t_Array32_TypeInfo id=7 */
    {
        /* call port (INIB) #_CP_# */ 
    ...
    /* cell: nTECSInfo_tArrayTypeInfo_CB_tab[7]:  char_t_Array256__Array16_TypeInfo id=8 */
    {
        /* call port (INIB) #_CP_# */ 
    ...
    /* cell: nTECSInfo_tArrayTypeInfo_CB_tab[8]:  char_t_Array256_TypeInfo id=9 */
    {
        /* call port (INIB) #_CP_# */ 
        &rTEMP_rTECSInfo_char_tTypeInfo_eTypeInfo_des, /* cTypeInfo #_CCP1_# */
        /* entry port #_EP_# */ 
...
/* 受け口ディスクリプタ #_EPD_# */
extern const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rTEMP_rTECSInfo_char_Array16_TypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tArrayTypeInfo_eTypeInfo_DES rTEMP_rTECSInfo_char_Array16_TypeInfo_eTypeInfo_des = {
    &nTECSInfo_tArrayTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tArrayTypeInfo_INIB_tab[0],   /* INIB 4 */
};
