...
#define nTECSInfo_tCellInfo_cRawEntryDescriptor_getRawDescriptor( p_that, subscript, ith, rawDesc ) \
	  (p_that)->cRawEntryDescriptor[subscript]->VMT->getRawDescriptor__T( \
	   (p_that)->cRawEntryDescriptor[subscript], (ith), (rawDesc) )
...
nTECSInfo_tCellInfo_cCelltypeInfo_refer_to_descriptor( nTECSInfo_tCellInfo_CB  *p_that )
{
    ...
    des.vdes = (struct tag_nTECSInfo_sCelltypeInfo_VDES *)p_that->cCelltypeInfo;
    return des;
}
...
nTECSInfo_tCellInfo_cRawEntryDescriptor_refer_to_descriptor( nTECSInfo_tCellInfo_CB  *p_that, int_t  i  )
{
    ...
    des.vdes = (struct tag_nTECSInfo_sRawEntryDescriptorInfo_VDES *)p_that->cRawEntryDescriptor[ i ];
    return des;
}
...
#define cRawEntryDescriptor_getRawDescriptor( subscript, ith, rawDesc ) \
          nTECSInfo_tCellInfo_cRawEntryDescriptor_getRawDescriptor( p_cellcb, subscript, ith, rawDesc )
