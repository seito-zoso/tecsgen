...
#define tTaskMain_cTECSInfo_findRawEntryDescriptor_unsafe( p_that, namespace_path, rawDesc ) \
...
#define cTECSInfo_findRawEntryDescriptor_unsafe( namespace_path, rawDesc ) \
          ((void)p_cellcb, tTaskMain_cTECSInfo_findRawEntryDescriptor_unsafe( p_cellcb, namespace_path, rawDesc ))
