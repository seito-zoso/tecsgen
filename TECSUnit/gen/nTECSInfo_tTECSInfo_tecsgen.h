...
Inline ER           nTECSInfo_tTECSInfo_eTECSInfo_findRawEntryDescriptor_unsafe( const char_t* namespace_path, void** rawDesc);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
#define nTECSInfo_tTECSInfo_cTECSInfo_findRawEntryDescriptor_unsafe( namespace_path, rawDesc ) \
	  nTECSInfo_tTECSInfoSub_eTECSInfo_findRawEntryDescriptor_unsafe( \
	    (namespace_path), (rawDesc) )
...
ER             nTECSInfo_tTECSInfo_eTECSInfo_findRawEntryDescriptor_unsafe_skel( const struct tag_nTECSInfo_sTECSInfo_VDES *epd, const char_t* namespace_path, void** rawDesc);
...
#define cTECSInfo_findRawEntryDescriptor_unsafe( namespace_path, rawDesc ) \
          nTECSInfo_tTECSInfo_cTECSInfo_findRawEntryDescriptor_unsafe( namespace_path, rawDesc )
